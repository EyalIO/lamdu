...
deriving instance (Eq n, Eq v) => Eq (Sugar.Payload v n Unit Unit)
...
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Case v n (OnceT (T i)) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.CaseArg v n (OnceT (T i)) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.CaseKind v n (OnceT (T i)) (T o) # Annotated a)
...
instance (NFData a, NFData n, NFData v) => NFData (Sugar.GetField v n (OnceT (T i)) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.IfElse v n (OnceT (T i)) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.Inject v n (OnceT (T i)) (T o) # Annotated a)
instance (NFData a, NFData n, NFData v) => NFData (Sugar.InjectContent v n (OnceT (T i)) (T o) # Annotated a)
...
instance (NFData n, NFData v) => NFData (Sugar.Payload v n (OnceT (T i)) (T o))
...
instance NFData (Sugar.NodeActions n (OnceT (T i)) (T o))
instance NFData (Sugar.NullParamActions (T o))
instance NFData (Sugar.NullaryVal n (OnceT (T i)) (T o))
